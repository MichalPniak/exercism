...
class HighScores {
    ...
    public int|null $latest = null;
    public int|null $personalBest = null;
    ...
    public function __construct(public array $scores) {
        ...
        $this->personalTopThreeScores();
    }

    public function latestScore() : void {
        $this->latest = $this->scores[count($this->scores) - 1];
    }

    public function personalBestScore() : void {
        $this->personalBest = max($this->scores);
    }

    public function personalTopThreeScores() : void {
        $scores = $this->scores;
        rsort($scores);
